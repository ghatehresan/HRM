...
| **D-1** | Stack فنی | **PHP 8.2+ + Laravel 12 + MySQL/MariaDB + Tailwind v4** *(پیش‌فرض تأیید ضمنی — کاربر سؤال را رد کرد و دستور ادامه داد)* | ۱۴۰۵/۰۷/۰۲ | تنها گزینهٔ سازگار با XAMPP و مهارت PHP تیم · شروع Milestone 1 |
